...
```json
{
  ...
  "source": ["Regulation Graph", "Form Field", "Historical Inspection Record"],
  "work_item": "施工架作業",
  "focus": "高處作業人員是否具備個人防護具與防墜措施",
  "checklist_fields": ["安全帽", "安全帶", "護欄", "踏板完整性"],
  "similar_cases": ["CASE-2025-0412", "CASE-2025-1020"],
...
```json
{
  "id": "OBS-001",
  "photo_id": "IMG-20260528-001",
  "description": "鷹架上方作業人員疑似未配戴安全帽",
  "location": "影像右上方，鷹架第三層",
  "linked_annotations": ["BOX-001"],
  "category_hint": ["PPE", "高處作業", "施工架"],
  "review_status": "待人工查核",
  "review_note": "頭部局部被鋼管遮蔽，需由職安人員確認"
}
```
